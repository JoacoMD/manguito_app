...
const routes: Routes = [
  ...
  { path: 'donaciones', canActivate: [AuthGuard], component: DonacionesComponent, children: [
      {path: '', pathMatch: 'full', redirectTo: 'manguitos'},
      {path: 'manguitos', component: ListaManguitosComponent}
    ]},
